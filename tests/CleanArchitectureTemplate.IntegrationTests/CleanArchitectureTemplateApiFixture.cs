...
public sealed class CleanArchitectureTemplateApiFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        HttpClient = _app.CreateHttpClient("cleanarchitecturetemplate-api");
        await _resourceNotificationService.WaitForResourceAsync("cleanarchitecturetemplate-api", KnownResourceStates.Running).WaitAsync(TimeSpan.FromSeconds(30));
    }
